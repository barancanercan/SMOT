...
def get_user_engagement_stats(username: str, start_date: str = None, end_date: str = None) -> Dict:
    """
...
def get_engagement_ranking(usernames: List[str], start_date: str = None, end_date: str = None) -> List[Dict]:
    """
...
def print_engagement_report(usernames: List[str], start_date: str = None, end_date: str = None):
    """Etkilesim raporu yazdir"""
    ranking = get_engagement_ranking(usernames, start_date, end_date)

    print(f"\n{'='*100}")
    print(f"ETKILESIM RAPORU")
