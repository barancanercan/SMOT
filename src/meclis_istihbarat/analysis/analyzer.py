...
from meclis_istihbarat.analysis.prompts import SYSTEM_PROMPT, get_prompt
from meclis_istihbarat.analysis.schemas import (
    TopicAnalysis,
...
# Default model - Optimized for CPU and Persona Stability
...
def analyze_user(username: str) -> Dict:
    ...
    Returns:
        Analiz sonucu
    """
    from meclis_istihbarat.core.db_config import session_scope
    from meclis_istihbarat.core.models import Tweet
