...
from meclis_istihbarat.core.database import init_database, clear_expired_cache
...
def update_profiles(usernames=None):
    ...
    """
    from meclis_istihbarat.scrapers.profile_scraper import ProfileScraper
...
def update_embeddings(usernames=None):
    ...
    Args:
        usernames: Guncellenecek kullanicilar (None = hepsi)
    """
    from meclis_istihbarat.analysis.vector_db import rebuild_index
