...
# Add backend to python path for standalone execution
sys.path.insert(0, os.path.dirname(os.path.dirname(__file__)))

from app.core.config import settings
from app.core.database import save_tweets_batch, init_database
from app.services.scraping.x_scraper import XTwitterScraper
